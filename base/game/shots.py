...
class Alcohol:
    ...
    nina_reaction: str | None = None
    table_pos: int | None = None


# ---- WATER ----------------------------
"""Water: Not an alcohol, still counts as a shot."""
shot_water: Alcohol = Alcohol(id="water", name="Water", abv=0.0, rarity=Rarity.Special, effect=None,
                              flavor_tags=[])

# ---- REAL ALCOHOLS --------------------
"""Vodka: The base alcohol. No effect."""
shot_vodka: Alcohol = Alcohol(id="vodka", name="Vodka", abv=0.4, rarity=Rarity.Common, effect=None,
                              flavor_tags=["Clean", "Spirit"])

"""Bourbon: Slight spite generation."""
shot_bourbon: Alcohol = Alcohol(id="bourbon", name="Bourbon", abv=0.45, rarity=Rarity.Common, effect=None,
                                flavor_tags=["Warm", "Spirit"])

"""Whiskey: No effect."""
shot_whiskey: Alcohol = Alcohol(id="whiskey", name="Whiskey", abv=0.50, rarity=Rarity.Common, effect=None,
                                flavor_tags=["Rough", "Herbal"])

"""Brandy: No effect."""
shot_brandy: Alcohol = Alcohol(id="brandy", name="Brandy", abv=0.40, rarity=Rarity.Common, effect=None,
                               flavor_tags=["Fruit", "Warm"])

"""Ale: No effect."""
shot_ale: Alcohol = Alcohol(id="ale", name="Ale", abv=0.12, rarity=Rarity.Common, effect=None,
                            flavor_tags=["Rough", "Floral"])

"""Tequila: Gives courage."""
shot_tequila: Alcohol = Alcohol(id="tequila", name="Tequila", abv=0.38, rarity=Rarity.Common, effect=None,
                                flavor_tags=["Agave", "Spirit"])

"""Gin: Sharpens senses slightly."""
shot_gin: Alcohol = Alcohol(id="gin", name="Gin", abv=0.42, rarity=Rarity.Common, effect=None,
                            flavor_tags=["Floral", "Spirit"])

"""Red Wine: Delayed BAC gain."""
shot_red_wine: Alcohol = Alcohol(id="wine", name="Red Wine", abv=0.14, rarity=Rarity.Common, effect=None,
                                 flavor_tags=["Sweet", "Grape"])

"""Champagne: Gives a small BAC reduction."""
shot_champagne: Alcohol = Alcohol(id="champagne", name="Champagne", abv=0.12, rarity=Rarity.Common, effect=None,
                                  flavor_tags=["Sweet", "Bubbly"])

"""Rum: Standard. No effect."""
shot_rum: Alcohol = Alcohol(id="rum", name="Rum", abv=0.40, rarity=Rarity.Common, effect=None,
                            flavor_tags=["Warm", "Spirit"])

"""Sake: Low ABV but increases the next source of alcohol"""
shot_sake: Alcohol = Alcohol(id="sake", name="Sake", abv=0.17, rarity=Rarity.Uncommon, effect=None,
                             flavor_tags=["Rice", "Subtle"])

"""Schnapps: Extremely sweet."""
shot_schnapps: Alcohol = Alcohol(id="schnapps", name="Schnapps", abv=0.2, rarity=Rarity.Common, effect=None,
                                 flavor_tags=["Sweet", "Fruit"])

"""Absinthe: High ABV and corrupts the UI. Nina loves it."""
shot_absinthe: Alcohol = Alcohol(id="absinthe", name="Absinthe", abv=0.68, rarity=Rarity.Rare, effect=None,
                                 flavor_tags=["Anise", "Void"])

"""Jägermeister: Neutralizes combos."""
shot_jaegermeister: Alcohol = Alcohol(id="jaegermeister", name="Jägermeister", abv=0.35, rarity=Rarity.Uncommon,
                                      effect=None, flavor_tags=["Sweet", "Herbal"])

"""Soju: No effect."""
shot_soju: Alcohol = Alcohol(id="soju", name="Soju", abv=0.25, rarity=Rarity.Uncommon, effect=None,
                             flavor_tags=["Clean", "Grain"])

"""Everclear: Extremely high ABV. Increases spite and corruption. Impresses Nina."""
shot_everclear: Alcohol = Alcohol(id="everclear", name="Everclear", abv=0.95, rarity=Rarity.Rare, effect=None,
                                  flavor_tags=["Spirit", "Pure"])

"""Moonshine: Blacks out an UI element for a turn."""
shot_moonshine: Alcohol = Alcohol(id="moonshine", name="Moonshine", abv=0.6, rarity=Rarity.Uncommon,
                                  effect=None, flavor_tags=["Grain", "Rough"])

"""Beer: Weak, reduces BAC gain."""
shot_beer: Alcohol = Alcohol(id="beer", name="Beer", abv=0.05, rarity=Rarity.Common, effect=None,
...
shot_hellfire: Alcohol = Alcohol(id="hellfire", name="Hellfire", abv=0.85, rarity=Rarity.Rare, effect=None,
                                 flavor_tags=["Demon", "Fire"])

"""Shadowmead: Reverses passive charm/item for the round"""
shot_shadowmead: Alcohol = Alcohol(id="shadowmead", name="Shadowmead", abv=0.3, rarity=Rarity.Uncommon,
                                   effect=None, flavor_tags=["Void", "Sweet"])

"""Ectofizz: Double or nothing."""
shot_ectofizz: Alcohol = Alcohol(id="ectofizz", name="Ectofizz", abv=0.2, rarity=Rarity.Uncommon, effect=None,
                                 flavor_tags=["Ghost", "Bubbly"])

"""Sip o' Styx: Curse. The next shots will always be hidden."""
shot_styx: Alcohol = Alcohol(id="styx", name="Sip o' Styx", abv=0.0, rarity=Rarity.Cursed, effect=None,
                             flavor_tags=["Void", "Cursed"])

"""Blooddemon: Shares BAC. Nina doesn't like this one."""
shot_blooddemon: Alcohol = Alcohol(id="blooddemon", name="Blooddemon", abv=0.6, rarity=Rarity.Rare, effect=None,
                                   flavor_tags=["Demon", "Warm"])

"""Spritepara: Scales ABV with Spite"""
shot_sprite: Alcohol = Alcohol(id="spritepara", name="Spritepara", abv=0.1, rarity=Rarity.Rare, effect=None,
                               flavor_tags=["Spirit", "Spite"])

"""Memoria: Reveals all shots next round for all"""
shot_memoria: Alcohol = Alcohol(id="memoria", name="Memoria", abv=0.15, rarity=Rarity.Uncommon, effect=None,
                                flavor_tags=["Herbal", "Clarity"])

"""Miss Echo: Rewards picking the same spot"""
shot_echo: Alcohol = Alcohol(id="echo", name="Miss Echo", abv=0.45, rarity=Rarity.Uncommon, effect=None,
                             flavor_tags=["Spirit", "Void"])

"""Light Starna: Corruption clears but comes back at double rate"""
shot_starna: Alcohol = Alcohol(id="starna", name="Light Starna", abv=0.25, rarity=Rarity.Rare, effect=None,
                               flavor_tags=["Light", "Pure"])

"""Bittersoul: Nina absolutely hates this."""
shot_bittersoul: Alcohol = Alcohol(id="bittersoul", name="Bittersoul", abv=0.5, rarity=Rarity.Uncommon,
...
shot_void: Alcohol = Alcohol(id="void", name="Void", abv=0.35, rarity=Rarity.Cursed, effect=None,
                             flavor_tags=["Void", "Cursed"])

"""Idunnol Lite: Divine drink."""
shot_idunn: Alcohol = Alcohol(id="idunn", name="Idunnol Lite", abv=0.22, rarity=Rarity.Rare, effect=None,
                              flavor_tags=["Pure", "Light"])

"""Zeusarinha: Fries the drinker's brain for a turn."""
shot_zeus: Alcohol = Alcohol(id="zeus", name="Zeusarinha", abv=0.55, rarity=Rarity.Rare, effect=None,
                             flavor_tags=["Spirit", "Wild"])

"""Siopi: Mute the person who drinks."""
shot_siopi: Alcohol = Alcohol(id="siopi", name="Siopi", abv=0.0, rarity=Rarity.Cursed, effect=None,
                              flavor_tags=["Void", "Cursed"])

"""Grandmother's Recipe: Corruption doesn't increace, Nina gains atleast 0.01 BAC no matter what."""
shot_grandmother: Alcohol = Alcohol(id="grandmother", name="Grandmother's Recipe", abv=0.7, rarity=Rarity.Rare,
                                    effect=None, flavor_tags=["Warm", "Pure"])

# ---- SIN ALCOHOLS ---------------------
"""SUPERBIA Aureola: The Wine of the Proud."""
shot_pride: Alcohol = Alcohol(id="pride", name="Aureola", abv=0.38, rarity=Rarity.Sin, effect=None,
                              flavor_tags=["Pride", "Light", "Warm", "Spirit"])

"""AVARITIA L'Usuraio: The Usurer's Draught"""
shot_greed: Alcohol = Alcohol(id="greed", name="L'Usuraio", abv=0.15, rarity=Rarity.Sin, effect=None,
                              flavor_tags=["Greed", "Spirit", "Wild"])

"""LUXURIA Tempasta Rosata: The Pink Tempest"""
shot_lust: Alcohol = Alcohol(id="lust", name="Tempasta Rosata", abv=0.45, rarity=Rarity.Sin, effect=None,
                             flavor_tags=["Lust", "Sweet", "Demon", "Bubbly"])

"""IRA Sangue dello Stige: Blood of the Styx"""
shot_wrath: Alcohol = Alcohol(id="wrath", name="Sangue dello Stige", abv=0.6, rarity=Rarity.Sin, effect=None,
                              flavor_tags=["Wrath", "Demon", "Spite", "Fire"])

"""GULA Il Pantano: The Mire"""
shot_gluttony: Alcohol = Alcohol(id="gluttony", name="Il Pantano", abv=0.3, rarity=Rarity.Sin, effect=None,
                                 flavor_tags=["Gluttony", "Grain", "Rough", "Cursed"])

"""ACCIDIA Acque Nere: The Black Waters"""
shot_sloth: Alcohol = Alcohol(id="sloth", name="Acque Nere", abv=0.2, rarity=Rarity.Sin, effect=None,
                              flavor_tags=["Sloth", "Void", "Subtle"])

"""INVIDIA Occhio Verde: The Green Eye"""
shot_envy: Alcohol = Alcohol(id="envy", name="Occhio Verde", abv=0.1, rarity=Rarity.Sin, effect=None,
                             flavor_tags=["Envy", "Void", "Spirit"])

# GEOGRAPHICAL SINS, EVEN RARER ------------------------------

"""COCYTUS Ghiaccio di Caina: Ice of Caina"""
shot_caina: Alcohol = Alcohol(id="caina", name="Ghiaccio di Caina", abv=0.0, rarity=Rarity.Sin, effect=None,
                              flavor_tags=["Void", "Cursed", "Clean"])

"""MALEBOLGE Frode Imbottigliata: Bottled Fraud"""
shot_fraud: Alcohol = Alcohol(id="fraud", name="Frode Imbottigliata", abv=0.5, rarity=Rarity.Sin, effect=None,
                              flavor_tags=["Fraud", "Cursed", "Void"])

# THE RAREST DRINK - TREACHERY
"""PRODITIO Il Terzo Morso: The Third Bite"""
shot_treachery: Alcohol = Alcohol(id="treachery", name="Il Terzo Morso", abv=0.8, rarity=Rarity.Sin,
